"""
Experimento 09 – Sesgos: Coverage/completeness.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Experimento 09 - Coverage completeness")
    ...
    print(f"Experimento 09 – Coverage/completeness. Corpus: {args.corpus_root} | Documentos: {n_files}")
