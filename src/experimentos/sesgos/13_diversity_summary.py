"""
Experimento 13 – Sesgos: Diversity summary (lee 1.3 y 1.5).
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Experimento 13 - Diversity summary (requiere 03, 05)")
    ...
    print("Experimento 13 – Diversity summary. Leyendo resultados 03, 05...")
